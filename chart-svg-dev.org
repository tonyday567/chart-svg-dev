...
In order, the following will be built (use -v for more details):
 - chart-svg-dev-0.0.2.0 (interactive) (lib) (file /Users/tonyday567/haskell/chart-svg-dev/dist-newstyle/build/aarch64-osx/ghc-9.12.2/chart-svg-0.8.2.1/cache/build changed)
...
#+RESULTS:
: Setting phasgehrcsi >t o stucn .::. . C(hpaorrttO p9t1i6o6n)s  (->c trIlO- c Btooo lq
: uit)
