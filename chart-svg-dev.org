...
In order, the following will be built (use -v for more details):
 - chart-svg-dev-0.0.2.0 (interactive) (lib) (configuration changed)
Configuring library for chart-svg-dev-0.0.2.0...
Preprocessing library for chart-svg-dev-0.0.2.0...
GHCi, version 9.12.2: https://www.haskell.org/ghc/  :? for help
[1 of 1] Compiling Chart.Dev        ( src/Chart/Dev.hs, interpreted )
...
#+RESULTS:
: Setting pghhacsie>r s to cs t::u n.C.h.a r(tpOoprtti o9n1s6 6->)  (IcOt rlB-oco lt
: o quit)
