...
- [X] remove placeText
- [X] tick lenses
- [-] remove Buffered, TextTickStyle, LineTickStyle
- [-] FrameOption anchorTo
- [-] review ScaleP
- [-] look at mempty examples for redundant markup snippets
  - [-] mempty & set #hudOptions defaultHudOptions & set #chartTree mempty produces a hud still?
- [-] replace .~ ~% ^.
- [ ] standard checklist
...
#+begin_src haskell-ng :results output
display $ dateExample & set #chartTree (blank (Rect 0 1 0 1))
#+end_src
